...
namespace Pastures2019.Models
{
    public class Soob
    {
        ...
        [Display(ResourceType = typeof(Resources.Controllers.SharedResources), Name = "DescriptionLat")]
        public string DescriptionLat { get; set; }
    }

    public class SoobIndexPageViewModel
    {
        public IEnumerable<Soob> Items { get; set; }
