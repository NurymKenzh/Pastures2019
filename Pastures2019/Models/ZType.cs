...
namespace Pastures2019.Models
{
    public class ZType
    {
        ...
        [Display(ResourceType = typeof(Resources.Controllers.SharedResources), Name = "Color")]
        public string Color { get; set; }
    }

    public class ZTypeIndexPageViewModel
    {
        public IEnumerable<ZType> Items { get; set; }
